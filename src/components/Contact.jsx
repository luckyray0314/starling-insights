  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      ...
      {                      // object with some options
        ...
        to_email: 'miyazaki19970314@gmail.com',
      ...
      >
        ...
        <div className='my-10'>
          ...
          <div className='flex flex-row items-center space-x-5 text-lg text-gray-300'>
            ...
            <div>
              ...
              <a onClick={() => copyToClipboard('miyazaki19970314@gmail.com')} className='underline cursor-pointer'>miyazaki19970314@gmail.com</a>
            </div>
          </div>
        </div>
        ...
        <div className='my-10'>
          ...
          <div className='flex flex-row items-center space-x-5 text-lg text-gray-300'>
            ...
            <div>
              ...
              <a onClick={() => copyToClipboard('luckyangel0615_85393')} className='underline cursor-pointer'>luckyangel0615_85393</a>
            </div>
          </div>
        </div>
        ...
        <div className='my-10'>
          ...
          <div className='flex flex-row items-center space-x-5 text-lg text-gray-300'>
            ...
            <div>
              <p className='text-2xl'>luckyangel314</p>
              <a href='https://github.com/luckyangel314' target='_blank' className='underline cursor-pointer'>https://github.com/luckyangel314</a>
            </div>
          </div>
        </div>
        {/* <form
